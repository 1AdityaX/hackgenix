...
<div class="w-full">
	<div class="flex items-end gap-2 rounded-xl border border-zinc-300 bg-white p-2 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
		<textarea
	...
	<p class="mt-2 text-xs text-zinc-500 dark:text-zinc-400">Enter to send · Shift+Enter for newline</p>
</div>
