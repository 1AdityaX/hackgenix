...
<main>
	<div class="flex min-h-screen bg-zinc-50 dark:bg-zinc-950">
		...
		<div class="flex flex-1 flex-col">
			<!-- Header -->
			<header
				class="border-b border-zinc-200 bg-white px-6 py-4 dark:border-zinc-800 dark:bg-zinc-900"
			>
			...
			<div class="border-t border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
				<div class="mx-auto max-w-4xl">
					<ChatInput placeholder="Type your message..." {loading} onsend={handleSend} />
				</div>
			</div>
		</div>
	</div>
